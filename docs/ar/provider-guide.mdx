---
title: دليل المزود
description: إعداد المزود خلال أقل من 5 دقائق: تسجيل، تثبيت daemon، التحقق من heartbeat، وبدء الربح.
order: 5
---

## إعداد المزود خلال 5 دقائق
...
- توزيع الإيراد: `75%` للمزود و`25%` للمنصة
