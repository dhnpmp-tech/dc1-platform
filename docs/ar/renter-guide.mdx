---
title: دليل المستأجر
description: إعداد المستأجر خلال أقل من 5 دقائق: الحساب، الرصيد، اختيار المزود، واستلام مخرجات أول مهمة.
order: 6
---

## إعداد المستأجر خلال 5 دقائق
...
4. أرسل أول مهمة من `/renter/playground` أو عبر API.
