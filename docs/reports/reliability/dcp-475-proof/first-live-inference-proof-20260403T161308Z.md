...
- generated_at: `2026-04-03T16:13:08.347Z`
- verdict: **FAIL**
- base_url: `https://api.dcp.sa`
- model: `ALLaM-AI/ALLaM-7B-Instruct-preview`
- smoke_principal: renter_id=`1774351995125` key_hint=`dc1-sk-5...0d44`
...
| health | 200 | 2 |  |  |
| models | 200 | 2 |  |  |
| completion_json | 503 | 6 |  | {"error":"no_capacity","message":"No online providers currently satisfy this model GPU requirement","diagnostics":{"model_id":"ALLaM-AI/ALLaM-7B-Instruct-preview","min_vram_gb":24,"capable_providers":0,"queued_vllm_jobs":0,"provider_heartbe |
...
- json: `docs/reports/reliability/dcp-475-proof/first-live-inference-proof-20260403T161308Z.json`
- markdown: `docs/reports/reliability/dcp-475-proof/first-live-inference-proof-20260403T161308Z.md`
- log: `docs/reports/reliability/dcp-475-proof/first-live-inference-proof-20260403T161308Z.log`
