...
export default function ProviderGuidePage() {
  return (
    <LegalPage title="Provider Guide" lastUpdated="March 12, 2026">
      ...
      <p>Visit <a href="/provider/register">dc1st.com/provider/register</a> and fill in your details: name, email, GPU model, and operating system. After registration, you will receive a unique API key — save this key securely, it is your authentication credential.</p>
      ...
      <h2>Earnings</h2>
      <p>You receive 75% of compute revenue. Earnings are tracked in real-time on your provider dashboard at <a href="/provider">dc1st.com/provider</a>. The dashboard shows today&apos;s earnings, weekly earnings, total earnings, and completed jobs.</p>
      ...
      <p>If your daemon shows as offline, check that the Python process is running and that your firewall allows outbound HTTPS connections. For further help, visit <a href="/support">dc1st.com/support</a>.</p>
    </LegalPage>
  )
}
