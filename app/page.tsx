...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero */}
      <section className="relative min-h-[78dvh] overflow-hidden border-b border-dc1-border/80 md:min-h-[86dvh]">
        ...
        <div className="relative mx-auto grid max-w-[1240px] gap-10 px-4 py-14 sm:px-6 md:py-20 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,0.9fr)] lg:gap-12 lg:px-8">
          <div>
            ...
            <h1 className={`${spaceGrotesk.className} max-w-[14ch] text-4xl font-semibold leading-[0.95] tracking-[-0.03em] text-dc1-amber sm:text-5xl lg:text-6xl`}>
