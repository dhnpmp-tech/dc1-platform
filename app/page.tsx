          ...
          <div>
            ...
            <div className={`mt-7 flex flex-col gap-3 transition-all delay-200 duration-500 sm:flex-row ${revealVisible ? 'translate-y-0 opacity-100' : 'translate-y-2 opacity-0'}`}>
              <Link
                ...
                className="btn btn-primary btn-lg inline-flex min-h-[44px] w-full items-center justify-center transition-transform duration-200 hover:-translate-y-[1px] sm:w-auto"
              >
              ...
              <Link
                ...
                className="btn btn-secondary btn-lg inline-flex min-h-[44px] w-full items-center justify-center transition-transform duration-200 hover:-translate-y-[1px] sm:w-auto"
              >
            ...
            <div className="rounded-2xl border border-dc1-border bg-dc1-surface-l1/90 p-5">
              ...
              <div className="mt-3 divide-y divide-dc1-border rounded-xl border border-dc1-border bg-dc1-surface-l2">
                <div className="flex items-center justify-between px-3 py-3">
                  ...
                  <p className="text-xl font-bold text-dc1-text-primary">
                    {liveGpuCount !== null ? liveGpuCount : <span className="inline-block h-6 w-10 animate-pulse rounded bg-dc1-surface-l3" aria-hidden="true" />}
                  </p>
                </div>
                <div className="flex items-center justify-between px-3 py-3">
                  <p className="text-xs uppercase tracking-[0.1em] text-dc1-text-secondary">{t('landing.reliability_gpu_families')}</p>
                  <p className="text-xl font-bold text-dc1-text-primary">
                    {gpuFamilyCoverage !== null ? gpuFamilyCoverage : <span className="inline-block h-6 w-10 animate-pulse rounded bg-dc1-surface-l3" aria-hidden="true" />}
                  </p>
                </div>
                <div className="flex items-center justify-between px-3 py-3">
      ...
      <section className="mx-auto w-full max-w-[1240px] px-4 py-14 sm:px-6 md:py-20 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-10">
          ...
          <div className="lg:col-span-6 bg-dc1-surface-l2 border border-dc1-border rounded-lg p-8 transition-all duration-200 hover:border-dc1-border-light hover:shadow-md group">
            ...
            <Link href="/renter/register" aria-label="Open browser playground registration" className="btn btn-primary btn-sm inline-flex min-h-[44px] items-center justify-center">
              Try the playground
            </Link>
          </div>
          ...
          <div className="lg:col-span-4 bg-dc1-surface-l2 border border-dc1-border rounded-lg p-8 transition-all duration-200 hover:border-dc1-border-light hover:shadow-md group">
            ...
            <Link href="/docs" aria-label="View DCP API documentation for container jobs" className="btn btn-secondary btn-sm inline-flex min-h-[44px] items-center justify-center">
              View API docs
            </Link>
          </div>
        </div>
