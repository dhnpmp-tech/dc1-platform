 ...
 *
 * Screen 1: Dashboard CTA card   — "Activate your GPU — earn SAR X/mo"
 * Screen 2: 3-step install wizard — OS select → install command → waiting for heartbeat
...
interface ProviderActivationCardProps {
  providerId: string
  apiKey: string
  /** Called when the provider completes onboarding */
  onComplete: () => void
}
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-dc1-text-secondary mb-4">
            Install the DCP daemon and connect your GPU to the marketplace.
            Setup takes under 5 minutes. Saudi providers earn SAR 4,500–15,750/month at 70% utilisation.
          </p>
...
function ActivationWizard({
  ...
  const STEP_LABELS = ['Select OS & install', 'Wait for connection', 'Connected!']
        ...
        {step === 2 && (
          <div className="space-y-5">
            <div>
              ...
              <p className="text-sm text-dc1-text-secondary">
                The daemon sends its first heartbeat automatically. This usually takes 30–60 seconds.
              </p>
            </div>
