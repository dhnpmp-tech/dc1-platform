...
function ProviderRegisterPageContent() {
  ...
  const selectedOsLabel = formData.operatingSystem || t('register.provider.readiness.os_fallback')
  ...
  const setupExpectation = normalizedOperatingSystem
    ? normalizedOperatingSystem === 'windows'
      ...
      : normalizedOperatingSystem === 'mac' || normalizedOperatingSystem === 'darwin'
        ? t('register.provider.setup_expectation.macos')
        : t('register.provider.setup_expectation.linux')
    : t('register.provider.setup_expectation.pending')
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-dc1-text-primary mb-2">
                      {t('register.provider.install_linux')}
                    </h3>
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-dc1-text-primary mb-2">
                      {t('register.provider.install_windows')}
                    </h3>
                    <div className="relative bg-dc1-surface-l3 rounded-md border border-dc1-border p-4 font-mono text-xs overflow-x-auto">
              ...
              <div className="card border-dc1-amber/20">
                ...
                <div className="rounded-lg border border-dc1-amber/25 bg-dc1-amber/5 p-4">
                  <p className="text-xs text-dc1-text-muted mb-2">
                    {t('register.provider.step_prefix')} {getProviderOnboardingStep(nextActionState)}
                  </p>
        ...
        <section className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="mb-6 rounded-2xl border border-dc1-amber/20 bg-dc1-surface-l1 p-5">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="rounded-xl border border-dc1-border bg-dc1-surface-l2 px-4 py-3 text-center sm:min-w-[144px]">
                ...
                <p className="text-xs text-dc1-text-secondary">
                  {readinessCompleteCount} {t('register.provider.readiness.of')} {readinessChecklist.length} {t('register.provider.readiness.complete')}
                </p>
              </div>
            </div>
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-3">
              ...
              <div className="rounded-xl border border-dc1-border bg-dc1-surface-l2 p-4">
                <p className="text-xs uppercase tracking-[0.14em] text-dc1-text-muted">{t('register.provider.readiness.next_step')}</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6" noValidate>
              ...
              <div>
                ...
                <div className="mb-3 grid grid-cols-1 gap-2 sm:grid-cols-2">
                  {[
                    { value: 'RTX 4090', label: 'RTX 4090', helper: t('register.provider.gpu.quick.rtx4090') },
                    { value: 'RTX 4080', label: 'RTX 4080', helper: t('register.provider.gpu.quick.rtx4080') },
                    { value: 'RTX 3090', label: 'RTX 3090', helper: t('register.provider.gpu.quick.rtx3090') },
                    { value: 'H100', label: 'H100', helper: t('register.provider.gpu.quick.h100') },
                  ].map((gpu) => (
                    <button
                      key={gpu.value}
                      type="button"
                ...
                >
                  ...
                  <option value="Other">{t('register.provider.option_other')}</option>
                </select>
              ...
              <div>
                ...
                <input
                  ...
                  value={formData.vram}
                  onChange={handleInputChange}
                  placeholder={formData.gpuModel === 'Other' ? t('register.provider.vram_placeholder_custom') : t('register.provider.vram_placeholder_auto')}
                ...
                {fieldErrors.vram ? (
                  ...
                  <p id="vram-hint" className="mt-2 text-xs text-dc1-text-muted">
                    {formData.gpuModel === 'Other' ? t('register.provider.vram_hint_custom') : `${t('register.provider.vram_hint_auto_prefix')} ${formData.gpuModel}.`}
                  </p>
                ) : (
                  <p id="vram-hint" className="mt-2 text-xs text-dc1-text-muted">
                    {t('register.provider.vram_hint_other_prefix')} <span className="font-semibold text-dc1-text-primary">{t('register.provider.option_other')}</span>.
                  </p>
                )}
              </div>
                ...
                <div>
                  ...
                  {fieldErrors.locationCountry ? (
                    ...
                    <p id="locationCountry-hint" className="mt-2 text-xs text-dc1-text-muted">
                      {t('register.provider.country_hint')}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mb-3 grid grid-cols-1 gap-2 sm:grid-cols-2">
                  {[
                    { value: 'Ubuntu 22.04', label: 'Ubuntu 22.04', helper: t('register.provider.os.quick.ubuntu2204') },
                    { value: 'Ubuntu 20.04', label: 'Ubuntu 20.04', helper: t('register.provider.os.quick.ubuntu2004') },
                    { value: 'Windows 10/11', label: 'Windows 10/11', helper: t('register.provider.os.quick.windows') },
                    { value: 'Other Linux', label: t('register.provider.os.other_linux'), helper: t('register.provider.os.quick.other_linux') },
                  ].map((os) => (
                    <button
                      key={os.value}
                      type="button"
                ...
                >
                  ...
                  <option value="Other Linux">{t('register.provider.os.other_linux')}</option>
                </select>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder={t('register.provider.phone_placeholder_inline')}
                  className="input"
                />
              </div>
              ...
              <div>
                <label className="label" htmlFor="referralCode">
                  {t('register.provider.referral_label')} <span className="text-dc1-text-muted font-normal">{t('register.provider.phone_optional')}</span>
                </label>
                <div className="flex gap-2">
                  ...
                  {referralCode && referralStatus === 'idle' && (
                    <span className="flex items-center text-xs text-dc1-text-muted px-2">{t('register.provider.referral_applied_inline')}</span>
                  )}
                </div>
                ...
                <p className="mt-1 text-xs text-dc1-text-muted">
                  {t('register.provider.referral_hint')}
                </p>
              </div>
              ...
              >
                {isLoading ? (
                  ...
                  canSubmit ? t('register.provider.submit') : t('register.provider.submit_incomplete')
                )}
              </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="card text-center">
              ...
              <h3 className="font-semibold text-dc1-text-primary mb-2">{t('register.provider.info.setup_title')}</h3>
              <p className="text-sm text-dc1-text-secondary">
                {t('register.provider.info.setup_desc')}
              </p>
            </div>
            ...
            <div className="card text-center">
              ...
              <h3 className="font-semibold text-dc1-text-primary mb-2">{t('register.provider.info.earn_title')}</h3>
              <p className="text-sm text-dc1-text-secondary">
                {t('register.provider.info.earn_desc')}
              </p>
            </div>
            ...
            <div className="card text-center">
              ...
              <h3 className="font-semibold text-dc1-text-primary mb-2">{t('register.provider.info.secure_title')}</h3>
              <p className="text-sm text-dc1-text-secondary">
                {t('register.provider.info.secure_desc')}
              </p>
            </div>
          </div>
        </section>
