...
export default function AcceptableUsePage() {
  return (
    <LegalPage title="Acceptable Use Policy" lastUpdated="March 12, 2026">
      <h2>Overview</h2>
      <p>This Acceptable Use Policy applies to all users of the DC1 GPU compute marketplace, including both providers and renters. Violations may result in immediate account suspension.</p>

      <h2>Permitted Uses</h2>
      <p>DC1 compute resources may be used for:</p>
      <ul>
      ...
      <p>The following activities are strictly prohibited on the DC1 platform:</p>
      <ul>
        ...
        <li><strong>Unauthorized resale</strong> — Reselling DC1 compute without written authorization</li>
