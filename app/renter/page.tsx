    ...
    <main className="min-h-screen bg-dc-black">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <Link
          ...
          className="block mb-8 bg-gradient-to-r from-[#00D9FF]/10 via-[#00D9FF]/5 to-transparent border border-[#00D9FF]/30 rounded-xl p-6 hover:border-[#00D9FF]/60 transition group"
        >
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-[#00D9FF] font-bold text-lg group-hover:text-white transition">Try LLM Playground</h3>
              <p className="text-gray-400 text-sm mt-1">Run AI models on real GPU hardware — type a prompt, pick a GPU, see the result with verifiable execution proof.</p>
            </div>
            <span className="text-[#00D9FF] text-2xl group-hover:translate-x-1 transition-transform">&rarr;</span>
          </div>
        </Link>
