...
describe('Rate limiting — providers active route (max: 30/min)', () => {
  it('returns 429 on the 31st unauthenticated request to /api/providers/active', async () => {
    const app = express();
    app.use(express.json());
    ...
    const statuses = await hitNTimes(app, 'get', '/api/providers/active', 31);
